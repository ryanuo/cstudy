...
static const char *FlashName(uint8_t mfr, uint8_t mem)
{
    if (mfr == 0xEF) {                       /* Winbond */
        switch (mem) {
            case 0x15: return "W25Q16";
            case 0x16: return "W25Q32";
            case 0x17: return "W25Q64";
            case 0x18: return "W25Q128";
            case 0x40: return "W25Q128";
            case 0x60: return "W25Q256";
            case 0x70: return "W25Q512";
        }
    }
    if (mfr == 0xC8) {                       /* GigaDevice */
        switch (mem) {
            case 0x16: return "GD25Q32";
            case 0x17: return "GD25Q64";
            case 0x18: return "GD25Q128";
            case 0x40: return "GD25Q128";
        }
    }
    if (mfr == 0x1C) {                       /* EON */
        switch (mem) {
            case 0x18: return "EN25Q128";
            case 0x40: return "EN25Q128";
        }
    }
    return "Unknown";
}
...
static uint32_t FlashSize(uint8_t mem)
{
    switch (mem) {
        ...
        case 0x40: return 16 * 1024 * 1024;
        case 0x60: return 32 * 1024 * 1024;
        case 0x70: return 64 * 1024 * 1024;
    }
    return 0;
}
...
uint8_t Flash_WebRoute(uint8_t link, const char *path, char *req)
{
    ...
    if (strcmp(path, "flash/read") == 0) {
        ...
        for (i = 0; i < len; i++) p += sprintf(p, "%02X", buf[i]);
        sprintf(p, "\"}");
