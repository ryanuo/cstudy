...
void Buzzer_Play(uint8_t song_id)
{
    switch (song_id) {
        case 1:
            Buzzer_PlayMusic(song_qifengle, sizeof(song_qifengle) / sizeof(MusicNote_t), 500);
            break;
        case 2:
            Buzzer_PlayMusic(song_qinghuaci, sizeof(song_qinghuaci) / sizeof(MusicNote_t), 500);
            break;
        default:
            break;
    }
